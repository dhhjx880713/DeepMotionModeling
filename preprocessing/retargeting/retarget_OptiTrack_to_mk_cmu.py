...
OptiTrack_MAKEHUMAN_JOINT_MAPPING = {
    'Hips': 'Hips',
    'LeftUpLeg': 'LeftUpLeg',
    'LeftLeg': 'LeftLeg',
    'LeftFoot': 'LeftFoot',
...
def retarget_captury_data():
    input_dir = r'D:\workspace\my_git_repos\capturesysevaluation\data\preprocessed\OptiTrack'
    ...
    root_joint = "Hips"
    retarget_folder(input_dir, skeleton_file, save_dir, OptiTrack_MAKEHUMAN_JOINT_MAPPING, root_joint=root_joint,
