...
def run_retarget_single_motion():
    ...
    # content_motion_file = r'D:\gits\PFNN\data\animations\LocomotionFlat03_000.bvh'
    content_motion_file = r'D:\workspace\experiment data\style_transfer_using_gram_matrix\edin_skeleton\proud\LocomotionFlat01_000_proud.bvh'
    ...
    save_path = r'D:\workspace\projects\retargeting_experiments\retargeted_results'
    root_joint = "Hips"
    ...
    retarget_single_motion(content_motion_file, skeleton_file, content_motion_file, save_path, root_joint,
                           target_body_plane, target_body_plane, EDIN_MAKEHUMAN_JOINT_MAPPING, n_frames=200)
...
def retarget_pfnn_data():
    ...
    save_folder = r'E:\workspace\mocap_data\mk_cmu_retargeting\pfnn_data'
...
def retarget_deep_learning_framework_data():
    skeleton_file = r'E:\workspace\mocap_data\skeleton_template\mk_cmu_T_pose.bvh'
    save_folder = r'E:\workspace\mocap_data\mk_cmu_retargeting\edin'
    src_folder = r'E:\gits\motionsynth_code\data\processed\edin'
    src_body_plane = target_body_plane = ['LeftUpLeg', 'Hips', 'RightUpLeg']
    root_joint = "Hips"
...
def retarget_pfnn_style_transfered():
    skeleton_file = r'D:\workspace\mocap_data\skeleton_template\mk_cmu_skeleton.bvh'
    save_folder = r'D:\workspace\mocap_data\mk_cmu_retargeting_default_pose\pfnn_style_transfer\sexy'
    src_folder = r'D:\workspace\mocap_data\raw_data\original_processed\sexy'
    src_body_plane = target_body_plane = ['LeftUpLeg', 'Hips', 'RightUpLeg']
    root_joint = "Hips"
    retarget_folder(src_folder, skeleton_file, save_folder, EDIN_MAKEHUMAN_JOINT_MAPPING, root_joint=root_joint,
                    src_body_plane=src_body_plane, target_body_plane=target_body_plane)
...
def retarget_motions():
    target_style = "old"
    skeleton_file = r'D:\workspace\mocap_data\skeleton_template\mk_cmu_skeleton.bvh'
    save_folder = r'D:\workspace\experiment data\style_transfer_using_gram_matrix\retarget' + os.sep + target_style
    src_folder = r'D:\workspace\experiment data\style_transfer_using_gram_matrix\edin_skeleton' + os.sep + target_style
    src_body_plane = target_body_plane = ['LeftUpLeg', 'Hips', 'RightUpLeg']
    root_joint = "Hips"
    retarget_folder_iteratively(src_folder, save_folder, skeleton_file, EDIN_MAKEHUMAN_JOINT_MAPPING, root_joint,
                                src_body_plane, target_body_plane)    
...
if __name__ == "__main__":
    ...
    # retarget_pfnn_style_transfered()
    retarget_motions()