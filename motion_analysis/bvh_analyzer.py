# encoding: UTF-8
from ..animation_data import Skeleton, QuaternionFrame, SKELETON_NODE_TYPE_END_SITE, LEN_EULER, LEN_ROOT,\
                                           LEN_QUAT, SkeletonBuilder
import numpy as np
from ..external.transformations import euler_matrix, euler_from_matrix
from .motion_plane import Plane
from ..animation_data.utils import pose_orientation_euler, check_quat, convert_quat_frame_value_to_array,\
     euler_to_quaternion, convert_euler_frames_to_quaternion_frames
from ..utilities.custom_math import angle_between_vectors
