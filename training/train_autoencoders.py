...
def train_autoencoder_channel_first(fine_tuning=False):
    ...
    encoder_op = motion_encoder_channel_first(input, name='encoder', hidden_units=64, pooling='average',
...
def train_autoencoder():
    accad_data = np.load(r'D:\workspace\my_git_repos\data\training_data\small_window_size/processed_accad_data.npz')['clips']
    cmu_data = np.load(r'D:\workspace\my_git_repos\data\training_data\small_window_size/processed_cmu_data.npz')['clips']
    stylized_data = np.load(r'D:\workspace\my_git_repos\data\training_data\small_window_size/processed_stylized_data.npz')['clips']
    ulm_data = np.load(r'D:\workspace\my_git_repos\data\training_data\small_window_size/processed_ulm_locomotion_data.npz')['clips']
    edin_data = np.load(r'D:\workspace\my_git_repos\data\training_data\small_window_size/processed_edin_locomotion_data.npz')['clips']
    rng = np.random.RandomState(23456)
...
def train_autoencoder_channel_first_without_pooling():
    ...
    stylized_data = np.load(r'D:\workspace\my_git_repos\data\training_data\small_window_size/processed_stylized_data.npz')['clips']
    ulm_data = np.load(r'D:\workspace\my_git_repos\data\training_data\small_window_size/processed_ulm_locomotion_data.npz')['clips']
    edin_data = np.load(r'D:\workspace\my_git_repos\data\training_data\small_window_size/processed_edin_data.npz')['clips']
    rng = np.random.RandomState(23456)
    X = np.concatenate([accad_data, cmu_data, stylized_data, edin_data, ulm_data], axis=0)
    X = np.swapaxes(X, 1, 2)
    Xmean = X.mean(axis=2).mean(axis=0)[np.newaxis, :, np.newaxis]
