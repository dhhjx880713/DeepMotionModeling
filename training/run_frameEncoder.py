...
def run_frameEncoder_quat():
    ...
    # export_point_cloud_data_without_foot_contact(reconstructed_motion, r'E:\tmp\recon_frameEncoder_quat.panim', scale_factor=scale_factor)
